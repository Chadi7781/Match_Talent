 ...
 * @author Lenovo
 */
public class ListUtilisateurs extends BaseForm{
    
    Form current;
    public ListUtilisateurs(Resources res ) {
        ...
        ArrayList<Utilisateur>list = ServiceUtilisateur.getInstance().getAllUsers();
    ...
    private void addButton(Image img,Utilisateur rec , Resources res) {
        ...
        Label objetTxt = new Label("Name : "+rec.getName(),"NewsTopLine2");
        Label dateTxt = new Label("email : "+rec.getEmail(),"NewsTopLine2");
        Label etatTxt = new Label("contact : "+rec.getContact(),"NewsTopLine2" );
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer ce reclamation ?","Annuler","Oui")) {
                ...
                if(ServiceUtilisateur.getInstance().deleteUser(rec.getId())) {
        ...
        lModifier.addPointerPressedListener(l -> {
            ...
            new ModifierUtilisateur(res,rec).show();
        });
